...
$verifyCommand = @(
    ...
    "curl -sS 'http://127.0.0.1:$ApiPort/api/v1/admin/pricing'",
    "curl -sS 'http://127.0.0.1:$ApiPort/api/v1/admin/dashboard/snapshot?recent_payments_limit=1&pending_incidents_limit=1'",
